...
export default function CourierDeliveryScreen({ onNext }: CourierDeliveryScreenProps) {
  ...
  return (
    <div className="relative w-full h-full bg-white flex flex-col pt-12 pb-6 px-4">
      ...
      {/* Heading */}
      <h1 className="text-3xl font-bold mb-2">Your Delivery Almost there…</h1>
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center">
          <div className="w-12 h-12 bg-gray-100 rounded-lg flex items-center justify-center mr-3 text-2xl border border-gray-200">
             📦
          </div>
          <div>
            <div className="font-bold text-lg">Package 01</div>
            <div className="text-sm text-gray-500">White Honda Civic • 7EL005</div>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4">
        <div>
          <div className="text-xs text-gray-500 font-semibold uppercase mb-1">Delivery up spot details</div>
