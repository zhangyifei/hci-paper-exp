  ...
  return (
    <div className="relative w-full min-h-screen bg-gray-50 flex flex-col pt-14 pb-6 px-5 animate-fade-in">
      ...
      <div className="w-full bg-gray-200 rounded-full h-1.5 mb-2 overflow-hidden">
        <div className="bg-black h-1.5 rounded-full w-[95%] animate-[pulse_2s_infinite]"></div>
      </div>
      <div className="text-[13px] text-gray-500 mb-8 font-medium">Latest arrival by 10:40</div>
